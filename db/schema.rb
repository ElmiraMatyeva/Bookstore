...
ActiveRecord::Schema.define(version: 20170708200825) do
  ...
  create_table "copyrights", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["author_id"], name: "index_copyrights_on_author_id"
    t.index ["book_id"], name: "index_copyrights_on_book_id"
  end
